...
time_table_insert = ("INSERT INTO time (start_time, hour, day, week, month, year, weekday) VALUES (%s, %s, %s, %s, %s, %s, %s) ON CONFLICT;")
...
song_select = ("SELECT \
                ...
                WHERE title = (%s) AND name = (%s) AND CAST(duration AS decimal) = (%s);")
